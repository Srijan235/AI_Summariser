  ...
  return (
   <header className='w-full flex justify-center items-center flex-col'>
      <nav className='flex justify-between items-center flex-row w-full mb-10 pt-3'>
       ...
       <button type="button" onClick={()=>window.open('https://github.com/Srijan235')} className=' black_btn'>GitHub</button>
       
     
      </nav>
       <h1 className='head_text'>Summarize Articles with<br className='max-md:hidden'></br>
        <span className='orange_gradient'>Open AI GPT-4</span>
       </h1>

       <h2 className='desc text-gray-300'>
